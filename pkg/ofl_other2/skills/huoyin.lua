...
Fk:loadTranslationTable{
  ...
  [':ofl__huoyin'] = '锁定技，你对攻击范围内含有你且你攻击范围内有其的其他角色：使用【杀】无次数限制；当你对这些角色造成伤害后，你摸一张牌，然后其选择是否使用一张牌。',
}
...
local huoyin_targetmod = fk.CreateSkill {
  name = "#ofl__huoyin_targetmod"
}

huoyin_targetmod:addEffect('targetmod', {
