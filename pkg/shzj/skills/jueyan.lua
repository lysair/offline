...
Fk:loadTranslationTable{
  ...
  [":shzj_juedai__jueyan"] = "出牌阶段限一次，你可以废除你装备区里的一种装备栏，然后执行对应的一项：武器栏，你本回合使用牌无次数限制；"..
  "防具栏，你摸三张牌并跳过本回合的弃牌阶段；坐骑栏，你本回合使用牌无距离限制且不能被响应；宝物栏，本回合获得〖集智〗。",

  ["#shzj_juedai__jueyan"] = "决堰：废除一种装备栏执行效果：<br>"..
  "武器栏-本回合使用牌无次数限制；  防具栏，摸三张牌并跳过弃牌阶段<br>"..
  "坐骑栏-本回合使用牌无距离限制且不能被响应；  宝物栏，本回合获得“集智”",

  ["$shzj_juedai__jueyan1"] = "",
  ["$shzj_juedai__jueyan2"] = "",
}
