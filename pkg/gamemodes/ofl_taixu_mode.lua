...
local desc = [[
  ...
  本模式是线下发行的**官方正版模式**，货号S0197，产品名《三国杀：国际服-太虚幻魇》。**与国际服线上规则不完全相同！**
  ...
  在一场游戏之前，玩家需按照说明书和关卡牌了解游戏目标，进行游戏设置。当结束所有关卡后，玩家人族阵营取得胜利；当关卡未结束时，玩家人族阵营失去了所有的游戏机会（后面会有具体描述），则另一阵营获胜。
  ...
  ①凡人初始有10点命数。游戏开始时，凡人随机从武将牌堆中抽取两张并获得两个技能（每关至多携带4个技能）。
  ...
  **第三关：董卓乱京**
  ...
  董卓进京之后残暴不仁，屠戮百姓，辱污皇权。曹操借王允之刀刺杀董卓失败，仓皇逃窜出关，他给踌躇不前的关外诸候带来一个恐怖的消息：董卓变得如此残暴，是有原因的……
  ...
  **第七关：霸王征程**
  ...
  孙策得到了自己父亲留下的原班人马的支持，又结识了文武双全的好友周瑜，凭借他们的支持，孙氏席卷江东。可是突然出现的太平于吉，让这位小霸王突然陨落。正当各方诸候的智囊在描度之后的天下会有何变化之时，有消息传来，说孙策死而复生，还带来了真正的“霸王项羽”。
